...
const embed = new Discord.RichEmbed()
.setColor('RANDOM')
.setTitle('EVOLUTİON - Fivem şehir paketi')
.setDescription(`📢-Merhabalar, **Paket hakkında ** soru veya sorunlarınız için Castillo#0001 ' a mesaj atabilirsiniz, test sunucumuza girmenizi tavsiye ediyoruz.  🙂 `)
